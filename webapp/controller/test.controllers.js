...
sap.ui.define([
    ...
    function (Controller, JSONModel, Core, MessagePopover, Element,
        ...
        return Controller.extend("test.validaciones.controller.View1", {
            onInit: function () {
                ...
                this._MessageManager.registerObject(this.oView.byId("formContainerPersonal"),
                    true);

                //this._MessageManager.registerObject(this.oView.byId("formContainerEmployment
                "), true);



                this.oView.setModel(this._MessageManager.getMessageModel(),
                    "message");
            ...
            // Set the button icon according to the message with the highest
            severity
   ...
   Warning > Success > Info
    mpIconFormatter: function () {
            ...
            //Display the button type according to the message with the
            highest severity
    //The priority of the message types are as follows: Error >
   Warning > Success > Info
    ...
    mpTypeFormatter: function () {
            ...
            mpSeverityMessages: function () {
                ...
                return
                this._MessageManager.getMessageModel().oData.reduce(function
                    (iNumberofMessages, oMessageItem) {
                    return oMessageItem.type === sHighestSeverityMessageType ?
                        ++iNumberofMessages : iNumberofMessages;
            ...
            checkInputConstraints: function (group, oInput) {
                ...
                switch (group) {
                    case "GR1":
                        ...
                        type = MessageType.Error;
                        description = "The value of the email field should be
   a valid email adress.";
                    ...
                    case "GR2":
                        ...
                        description = "The value of the working hours field
   should not exceed 40 hours.";
            ...
            onChange: function (oEvent) {
                ...
                if (oInput.getLabels()[0].getText() === "Standard Weekly
   Hours") {
    ...
    saveData: function () {
        ...
        let oNameInput =
            oView.byId("formContainerPersonal").getItems()[0].getContent()[2];
        let oEmailInput =
            this.oView.byId("formContainerPersonal").getItems()[0].getContent()[12];
        let iWeeklyHours =
            this.oView.byId("formContainerEmployment").getItems()[0].getContent()[13];
