		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Control Validaciones",
									"targetURL": "#testvalidaciones-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"testvalidaciones-display": {
								"semanticObject": "testvalidaciones",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=test.validaciones",
									"url": sap.ui.require.toUrl("test/validaciones")
								}
							}
						}
					}
