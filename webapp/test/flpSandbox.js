		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Import Excel",
									"targetURL": "#macdevzexcelimport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"macdevzexcelimport-display": {
								"semanticObject": "macdevzexcelimport",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=macdev.zexcelimport",
									"url": sap.ui.require.toUrl("macdev/zexcelimport")
								}
							}
						}
					}
